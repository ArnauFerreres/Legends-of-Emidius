...
public class SightRangeEditor : Editor
{
    private void OnSceneGUI()
    {
        ...
        Vector3 viewAngle1 = DirectionFromAngle(enemy.transform.eulerAngles.y, -enemy.GetSightAngle() / 2);
        Vector3 viewAngle2 = DirectionFromAngle(enemy.transform.eulerAngles.y, enemy.GetSightAngle() / 2);
